...
# Streamlit
st.title("Система автоматического распознавания и заполнения Заявки на оплату в 1С.УХ")
st.write("Этот инструмент позволяет загрузить PDF, преобразовать его в изображения и распознать текст с помощью YOLO и OCR.")
